...
class contesttracker(commands.Cog):
    ...
    async def contests(self, interaction: discord.Interaction, ign: str, time_period: Literal["1 day", "1 week", "1 month", "6 months", "1 year", "2 years", "3 years"] = "1 week"):
        ...
        timestable = {"1 days": 86400, "1 week": 604800, "1 month": 2629743, "6 months": 15778458, "1 year": 31556926, "2 years": 31556926*2, "3 years": 31556926*3}
        ...
        for contest in contests:
            ...
            skyblockunix = int(year)*365*60*20+int(month)*31*60*20+int(day)*60*20+1560275700
            if currenttime // timestable[time_period] == skyblockunix // timestable[time_period]:
        ...
        for contest in contestsInTimePeriod:
            try:
                ...
                send[datetime.datetime.fromtimestamp(contest).hour] = 0
        counter = 0
        timers = []
        timecounter = 0
        counters = ()
