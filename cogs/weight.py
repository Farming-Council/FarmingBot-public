...
async def calculate_farming_weight(self, ign, profile=""):
    ...
    if member:
        ...
        # Calculate weight for mushrooms dynamically
        ...
        for i in member["jacob2"]["contests"]:
            try:
                ...
                try:
                    if member["jacob2"]["contests"][i]["claimed_position"] <= member["jacob2"]["contests"][i][
                        "claimed_participants"] * 0.05 + 1:
                        gold += 1
                except:
                    pass
                pass
        ...
        return [1, {"profile": profile, "total": weight,
